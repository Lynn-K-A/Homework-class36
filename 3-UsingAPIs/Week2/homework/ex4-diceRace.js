...
function rollDice() {
  ...
  const newDice = dice.map((x) => rollDie(x));
  return Promise.race(newDice);
}
...
//looks like the events are scheduled to happen for a specific amount even after the dice resolves.
