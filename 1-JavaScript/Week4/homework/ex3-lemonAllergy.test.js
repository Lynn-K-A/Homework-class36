...
// ! Function under test
function sanitizeFruitBasket(fruitsArr, fruitToBeTakenOut) {
  const sanitizedFruits = fruitsArr.filter(element => element !== fruitToBeTakenOut);
